...
function SingleRecordDetails() {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert cancer and heart and any disease diagnosis analyst. Use your knowledge base to answer questions about giving personalized recommended treatments.
